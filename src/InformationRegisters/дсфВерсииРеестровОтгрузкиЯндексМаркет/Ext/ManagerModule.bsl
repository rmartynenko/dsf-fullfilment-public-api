...
Процедура ДобавитьЗапись(СтруктураЗаписи, Загрузка = Ложь) Экспорт
	...
	дсфОбменДаннымиСлужебный.ДобавитьЗаписьВРегистрСведений(СтруктураЗаписи, "дсфВерсииРеестровОтгрузкиЯндексМаркет", Загрузка);
...
Процедура УдалитьЗапись(СтруктураЗаписи, Загрузка = Ложь) Экспорт
	...
	дсфОбменДаннымиСлужебный.УдалитьНаборЗаписейВРегистреСведений(СтруктураЗаписи,
																	"дсфВерсииРеестровОтгрузкиЯндексМаркет",
																	Загрузка);
...
Процедура ОбновитьЗапись(СтруктураЗаписи) Экспорт
	...
	дсфОбменДаннымиСлужебный.ОбновитьЗаписьВРегистреСведений(СтруктураЗаписи, "дсфВерсииРеестровОтгрузкиЯндексМаркет");
...
//
Функция ЗаписьЕстьВРегистре(ЗаявкаНаОтгрузку, ИдентификаторРеестра) Экспорт
	
	Запрос = Новый Запрос(
	"ВЫБРАТЬ ПЕРВЫЕ 1
	|	ИСТИНА КАК ЕстьЗапись
	|ИЗ
	|	РегистрСведений.дсфВерсииРеестровОтгрузкиЯндексМаркет КАК ВерсииРеестровОтгрузкиЯндексМаркет
	|ГДЕ
	|	ВерсииРеестровОтгрузкиЯндексМаркет.ЗаявкаНаОтгрузку = &ЗаявкаНаОтгрузку
	|	И ВерсииРеестровОтгрузкиЯндексМаркет.ИдентификаторРеестра = &ИдентификаторРеестра");
