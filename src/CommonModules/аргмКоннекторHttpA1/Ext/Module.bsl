...
Функция ОтправитьHTTPЗапрос(Сессия, ПодготовленныйЗапрос, Настройки)
	...
	// (логирование	
	URLДляЛога = СтруктураURL.Сервер + СтруктураURL.Путь;
	ЛогHTTPЗапроса = аргмЛогированиеHttpA1.ОткрытьЛогHTTPЗапроса(URLДляЛога);
	аргмЛогированиеHttpA1.УстановитьURL(ЛогHTTPЗапроса, URLДляЛога);
	аргмЛогированиеHttpA1.УстановитьМетодHTTPЗапроса(ЛогHTTPЗапроса, ПодготовленныйЗапрос.Метод);
	аргмЛогированиеHttpA1.УстановитьТелоЗапроса(ЛогHTTPЗапроса,
													ПодготовленныйЗапрос.HTTPЗапрос.ПолучитьТелоКакСтроку());
	
	аргмЛогированиеHttpA1.НачатьЗамерВремени(ЛогHTTPЗапроса); 

	Ответ = Соединение.ВызватьHTTPМетод(ПодготовленныйЗапрос.Метод, ПодготовленныйЗапрос.HTTPЗапрос);
	
	аргмЛогированиеHttpA1.ЗакрытьЛогHTTPЗапроса(ЛогHTTPЗапроса, Ответ);
...
Функция ПараметрыПреобразованияJSONПоУмолчанию()
	...
	ПараметрыПреобразованияПоУмолчанию.Вставить("ИмяФункцииПреобразования", "ПреобразованиеJson");
	ПараметрыПреобразованияПоУмолчанию.Вставить("МодульФункцииПреобразования", аргмКоннекторHttpA1);
