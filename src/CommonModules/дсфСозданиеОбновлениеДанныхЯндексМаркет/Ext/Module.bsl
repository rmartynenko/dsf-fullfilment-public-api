...
Функция НовоеОписаниеЗаявкиНаОтгрузку() Экспорт
	...
	ОписаниеЗаявки.Вставить("ТипОтправки", Перечисления.дсфТипыОтправкиЯндексМаркет.СПартнерскогоСклада);
...
Процедура СоздатьОбновитьЗаявкуНаОтгрузку(ДанныеЗаявки, РезультатОбработки) Экспорт
	...
	Попытка
		...
		Иначе
			...
			// dsf_СвязанныеОбъектыЗаявкаНаПриемку
			РегистрыСведений.дсфСвязанныеОбъектыЗаявкаНаОтгрузкуЯндексМаркет.ДобавитьНовуюЗапись(СсылкаНаНовый);
