...
Функция ВидОбъектаХраненияПоТипуТовара(ТипТовара) Экспорт 
	...
	Запрос.Текст = "ВЫБРАТЬ ПЕРВЫЕ 1
	               |	дсфСоответствиеВидовОбъектовХраненияТипамТоваровЯндексМаркет.ВидОбъектаХранения КАК ВидОбъектаХранения
	               |ИЗ
	               |	РегистрСведений.дсфСоответствиеВидовОбъектовХраненияТипамТоваровЯндексМаркет КАК дсфСоответствиеВидовОбъектовХраненияТипамТоваровЯндексМаркет
	               |ГДЕ
	               |	дсфСоответствиеВидовОбъектовХраненияТипамТоваровЯндексМаркет.ТипТовара = &ТипТовара";
